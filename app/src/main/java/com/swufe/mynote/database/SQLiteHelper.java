...
public class SQLiteHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db){
        db.execSQL("CREATE TABLE "+DBUtils.DATABASE_TABLE+"("+DBUtils.NOTEPAD_ID+" INTEGER PRIMARY KEY AUTOINCREMENT,"+DBUtils.NOTEPAD_HEAD+" text, "+DBUtils.NOTEPAD_CONTENT+" text, "+DBUtils.NOTEPAD_TIME+" text)");
    }

    @Override
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) { }
    //添加数据
    public boolean insertData(String userHead, String userContent, String userTime){
        ContentValues contentValues=new ContentValues();
        contentValues.put(DBUtils.NOTEPAD_HEAD,userHead);
    ...
    //修改数据
    public boolean updateData(String id, String head, String content, String userYear){
        ContentValues contentValues=new ContentValues();
        contentValues.put(DBUtils.NOTEPAD_HEAD,head);
    ...
    public List<NotepadBean> query(){
        ...
        if (cursor!=null){
            while (cursor.moveToNext()){
                ...
                String head=cursor.getString(cursor.getColumnIndex(DBUtils.NOTEPAD_HEAD));
